...
export default async function ShowAutoGeneratedConference(props: Props) {
    ...
    if (existingConferenceResult.docs.length > 0) {
        // Conference already exists, redirect to /conferences/{slug}
